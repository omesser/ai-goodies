...
| [deanpeters/Product-Manager-Skills](https://github.com/deanpeters/Product-Manager-Skills) | Dean Peters | 56 skills + 6 command workflows for product management (discovery, prioritization, PRDs, roadmapping, stakeholder mapping, AI-product strategy); plugin marketplace for Claude Code, Codex, Cursor, n8n | ~5.7k stars, pushed weekly; the deepest PM-specific skill library — each skill also teaches the framework's reasoning, not just its output. |
